...
from classes import ModelActor, ModelCritic, AgentA2C

from ac_gym_v0 import AttitudeControlEnv
...
if __name__ == '__main__':
    ...
    env = AttitudeControlEnv() ###*****CHANGE
    #test_env = GymEnv42()
    env = TimeLimit(env, max_episode_steps=500)

    net_act = ModelActor(env.observation_space.shape[0], env.action_space.n).to(device)
    ...
    with ptan.common.utils.RewardTracker(writer) as tracker:
        for step_idx, exp in enumerate(exp_source):
            #print('starting pop_rewards_steps')
